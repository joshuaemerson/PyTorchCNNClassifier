...
from .utils import show_fashion_mnist_image, get_data_loaders
...
# Set up the Data Loaders for the Train, Val, and Test Datasets
train_loader, val_loader, test_loader = get_data_loaders(fashion_trainset, fashion_testset, 16)
